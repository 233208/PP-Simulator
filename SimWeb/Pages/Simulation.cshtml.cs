...
public class Simulation : PageModel
{
    ...
    private void SetGrid(int turn)
    {
        ...
        var map = App.SimulationHistory.Map();
    ...
    public string GetImagePath(char symbol) => _symbolToImagePath.ContainsKey(symbol) ? _symbolToImagePath[symbol] : "/images/fight.png";
